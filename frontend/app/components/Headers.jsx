        ...
        <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex
         flex-col items-center justify-center gap-4">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mt-4"> 
                <motion.a href="#contact" className="px-10 py-3 border border-white rounded-full
                ...
                <motion.a href="/sample-resume.pdf" className="px-10 py-3 rounded-full border border-gray-500 
